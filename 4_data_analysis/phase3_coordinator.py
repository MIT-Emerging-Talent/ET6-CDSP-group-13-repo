...
class Phase3DataCoordinator:
    ...
    def __init__(self):
        ...
        self.crisis_events = [
            ...
            # Venezuela crises
            {
                "country": "VE",
                "date": "2018-08-20",
                "event": "Currency redenomination",
                "severity": "HIGH",
            },
            {
                "country": "VE",
                "date": "2019-01-23",
                "event": "Juan Guaidó declares presidency",
                "severity": "MEDIUM",
            },
            # Argentina economic events
            {
                "country": "AR",
                "date": "2019-08-11",
                "event": "Peso devaluation after primary elections",
                "severity": "MEDIUM",
            },
            {
                "country": "AR",
                "date": "2020-04-22",
                "event": "Debt default announcement",
                "severity": "MEDIUM",
            },
            # Afghanistan crisis
            {
                "country": "AF",
                "date": "2021-08-15",
                "event": "Taliban takeover of Kabul",
                "severity": "HIGH",
            },
            # Nigeria events
            {
                "country": "NG",
                "date": "2020-10-20",
                "event": "Central bank restricts crypto",
                "severity": "MEDIUM",
            },
            # Zimbabwe events
            {
                "country": "ZW",
                "date": "2019-02-20",
                "event": "Currency crisis escalation",
                "severity": "HIGH",
            },
        ]

        print("🎯 Phase 3 Data Coordinator initialized")
                ...
                try:
                    ...
                    if not history.empty:
                        ...
                        filepath = os.path.join(
                            self.data_dir, "historical", "yahoo_finance", filename
                        )
                ...
                if "BTC-USD" in historical_data:
                    ...
                    if len(window_data) > 10:  # Ensure sufficient data
                        ...
                        if len(pre_crisis) > 0 and len(post_crisis) > 0:
                            ...
                            print("   ⚠️  Insufficient data around crisis date")
                    else:
    ...
    def collect_current_validation_data(self):
        ...
        try:
            ...
            target_countries = [
                ...
                "AR",
                "AF",
            ]  # Start with proven working countries
                ...
                try:
                    ...
                    if country_info and "fiat_currency" in country_info:
                        ...
                        if sell_ads:
                            ...
                            print(
                                f"   ✅ {country}: {premium_pct:+.1f}% premium ({len(sell_ads)} ads)"
                            )
                        else:
    ...
    def generate_research_summary(
        ...
        if crisis_analysis:
            ...
            if len(high_impact) > 0:
                ...
                for _, crisis in high_impact.iterrows():
                    print(
                        f"   {crisis['event']} ({crisis['country']}): {crisis['price_change_pct']:+.1f}%"
                    )
        ...
        summary_path = os.path.join(
            self.data_dir, "analysis", f"research_summary_{self.today}.json"
        )
        import json
...
def main():
    ...
    print("🎯 Ready for academic analysis and publication preparation")
